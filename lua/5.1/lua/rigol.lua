...
function rigol:trace(setting) -- for lack of a better argument name
    local ret = {}	
	setmetatable(setting,{__index={start=30.0e6,stop=1.0e9,det='POS',sweeps=1}})
	local start,stop,det,sweeps =
	setting[1] or setting.start,
	setting[2] or setting.stop,
	setting[3] or setting.det,
	setting[3] or setting.sweeps
